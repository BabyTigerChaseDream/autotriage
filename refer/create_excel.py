...
def GetProduct(uuid):
    ...
    vlcps = {
                      ...
                      "CUDA 8.0 r390"                  : "//sw/rel/gpgpu/toolkit/r8.0/eris/cuda_r390.vlcp",
                      ...
                      "CUDA 8.0 r390 sm20"             : "//sw/rel/gpgpu/toolkit/r8.0/eris/cuda_r390_sm20.vlcp",
                      "CUDA 8.0 cuda_a sm20"           : "//sw/rel/gpgpu/toolkit/r8.0/eris/cuda_cuda_a_sm20.vlcp",
                      "CUDA 9.0 r384"                  : "//sw/rel/gpgpu/toolkit/r9.0/eris/cuda_r384.vlcp",
                      "CUDA 9.1 r387"                  : "//sw/rel/gpgpu/toolkit/r9.1/eris/cuda_r387.vlcp",
                      "CUDA 9.1 r390"                  : "//sw/rel/gpgpu/toolkit/r9.1/eris/cuda_r390.vlcp",
                      "CUDA 9.2 r396"                  : "//sw/rel/gpgpu/toolkit/r9.2/eris/cuda_r396.vlcp",
                      "CUDA 9.2 cuda_a"                : "//sw/rel/gpgpu/toolkit/r9.2/eris/cuda_cuda_a.vlcp",
					  ...
					  "ICE 1.2 gpgpu cuda_a"           : "//sw/gpgpu/eris/ice12.vlcp",
                      ...
                      "NCCL Public V1.2 CUDA 8.0 r375" : "//sw/gpgpu/nccl/eris/nccl_80_public_r375.vlcp",
                      ...
                      "NCCL Private V1.5 CUDA8.0 r375" : "//sw/gpgpu/nccl/eris/nccl_80_private_r375.vlcp",
                      "NCCL Public V1.3 CUDA 7.5 r352" : "//sw/gpgpu/nccl/eris/nccl_75_public.vlcp",
                      "NCCL Public V1.3 CUDA 8.0 r361" : "//sw/gpgpu/nccl/eris/nccl_80_public.vlcp",
                      "NCCL Public V1.3 CUDA 8.0 r367" : "//sw/gpgpu/nccl/eris/nccl_80_public_r367.vlcp",
                      "NCCL Public V1.3 CUDA 8.0 r375" : "//sw/gpgpu/nccl/eris/nccl_80_public_r375.vlcp",
                      "NCCL Public V1.3 CUDA 8.0 r378" : "//sw/gpgpu/nccl/eris/nccl_80_public_r378.vlcp",
                      "NCCL Private V1.6 CUDA7.5 r352" : "//sw/gpgpu/nccl/eris/nccl_75_private.vlcp",
                      "NCCL Private V1.6 CUDA8.0 r361" : "//sw/gpgpu/nccl/eris/nccl_80_private.vlcp",
                      "NCCL Private V1.6 CUDA8.0 r367" : "//sw/gpgpu/nccl/eris/nccl_80_private_r367.vlcp",
                      "NCCL Private V1.6 CUDA8.0 r375" : "//sw/gpgpu/nccl/eris/nccl_80_private_r375.vlcp",
                      "NCCL Private V1.6 CUDA8.0 r378" : "//sw/gpgpu/nccl/eris/nccl_80_private_r378.vlcp",
                      "NCCL Private V1.6 gpgpu cuda_a" : "//sw/gpgpu/nccl/eris/nccl_private_gpgpu_cuda_a.vlcp",
                      ...
                      "OpenCL gpgpu r387"              : "//sw/gpgpu/opencl/eris/r387_00/opencl.vlcp",
                      ...
                      "OpenMPI CUDA 8.0 r375"          : "//sw/rel/gpgpu/toolkit/r8.0/eris/openmpi_r378.vlcp",
                      ...
                      "UVM 8.0 r378"                   : "//sw/rel/gpgpu/toolkit/r8.0/eris/uvm_r378.vlcp",
					  "UVM 9.0 chips_a"                : "//sw/rel/gpgpu/toolkit/r9.0/eris/uvm_chips_a.vlcp",
		              "UVM 9.1 chips_a"                : "//sw/rel/gpgpu/toolkit/r9.1/eris/uvm_chips_a.vlcp",
                      "UVM 9.0 r384"                   : "//sw/rel/gpgpu/toolkit/r9.0/eris/uvm_r384.vlcp",
                      "UVM 9.1 r387"                   : "//sw/rel/gpgpu/toolkit/r9.1/eris/uvm_r387.vlcp",
                      "UVM 9.1 r390"                   : "//sw/rel/gpgpu/toolkit/r9.1/eris/uvm_r390.vlcp"
                    }
...
def Addtestcmd(uuid,testsuites,vlcp):
    for i in testsuites:
        if i is not None:
            ...
            cmd = "vulcan -v --eris --product=%s --build --testsuite %s --target-revision=cl-tot --target-gpu=%s --target-os=%s --target-arch=%s %s %s --tag=%s"%(vlcp,i[0],i[2],i[3],i[4],test_arch,compiler,tags)
            cmdlist = [cmd]
            i.extend(cmdlist)
    return testsuites
...
def Addbuildcmd(uuid,buildsuites,vlcp):
    for i in buildsuites:
        if i is not None:
            ...
            cmd = "vulcan -v --eris --product=%s --build %s --target-revision=cl-tot  --target-os=%s --target-arch=%s %s --tag=%s"%(vlcp,i[0],os,i[3],compiler,tags)
            cmdlist = [cmd]
            i.extend(cmdlist)
    return buildsuites
